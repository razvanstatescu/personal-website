...
export const alt = "Razvan Statescu — Founder & Indie Hacker";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Founder and indie hacker building in public
          </p>
          ...
          >
            {["founder", "indie hacker", "build in public", "react native", "AI apps", "shipped solo"].map((keyword) => (
              <div
                key={keyword}
                style={{
                  display: "flex",
